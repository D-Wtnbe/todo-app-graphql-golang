...
func (tu *TaskUpdate) AddAssignedToIDs(ids ...int) *TaskUpdate {
	tu.mutation.AddAssignedToIDs(ids...)
	return tu
}

// AddAssignedTo adds the "assigned_to" edges to the User entity.
func (tu *TaskUpdate) AddAssignedTo(u ...*User) *TaskUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return tu.AddAssignedToIDs(ids...)
}
...
// ClearAssignedTo clears all "assigned_to" edges to the User entity.
func (tu *TaskUpdate) ClearAssignedTo() *TaskUpdate {
	tu.mutation.ClearAssignedTo()
	return tu
}

// RemoveAssignedToIDs removes the "assigned_to" edge to User entities by IDs.
func (tu *TaskUpdate) RemoveAssignedToIDs(ids ...int) *TaskUpdate {
	tu.mutation.RemoveAssignedToIDs(ids...)
	return tu
}

// RemoveAssignedTo removes "assigned_to" edges to User entities.
func (tu *TaskUpdate) RemoveAssignedTo(u ...*User) *TaskUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return tu.RemoveAssignedToIDs(ids...)
}
...
func (tu *TaskUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := tu.mutation.RemovedAssignedToIDs(); len(nodes) > 0 && !tu.mutation.AssignedToCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   task.AssignedToTable,
...
// AddAssignedToIDs adds the "assigned_to" edge to the User entity by IDs.
func (tuo *TaskUpdateOne) AddAssignedToIDs(ids ...int) *TaskUpdateOne {
	tuo.mutation.AddAssignedToIDs(ids...)
	return tuo
}

// AddAssignedTo adds the "assigned_to" edges to the User entity.
func (tuo *TaskUpdateOne) AddAssignedTo(u ...*User) *TaskUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return tuo.AddAssignedToIDs(ids...)
}
...
// ClearAssignedTo clears all "assigned_to" edges to the User entity.
func (tuo *TaskUpdateOne) ClearAssignedTo() *TaskUpdateOne {
	tuo.mutation.ClearAssignedTo()
	return tuo
}

// RemoveAssignedToIDs removes the "assigned_to" edge to User entities by IDs.
func (tuo *TaskUpdateOne) RemoveAssignedToIDs(ids ...int) *TaskUpdateOne {
	tuo.mutation.RemoveAssignedToIDs(ids...)
	return tuo
}

// RemoveAssignedTo removes "assigned_to" edges to User entities.
func (tuo *TaskUpdateOne) RemoveAssignedTo(u ...*User) *TaskUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return tuo.RemoveAssignedToIDs(ids...)
}
...
func (tuo *TaskUpdateOne) sqlSave(ctx context.Context) (_node *Task, err error) {
	...
	if nodes := tuo.mutation.RemovedAssignedToIDs(); len(nodes) > 0 && !tuo.mutation.AssignedToCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   task.AssignedToTable,
