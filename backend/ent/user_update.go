...
func (uu *UserUpdate) AddAssignedTaskIDs(ids ...int) *UserUpdate {
...
func (uu *UserUpdate) RemoveAssignedTaskIDs(ids ...int) *UserUpdate {
...
// AddAssignedTaskIDs adds the "assigned_tasks" edge to the Task entity by IDs.
func (uuo *UserUpdateOne) AddAssignedTaskIDs(ids ...int) *UserUpdateOne {
...
// RemoveAssignedTaskIDs removes the "assigned_tasks" edge to Task entities by IDs.
func (uuo *UserUpdateOne) RemoveAssignedTaskIDs(ids ...int) *UserUpdateOne {
